      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                { to: '/', label: 'Home' },
                { to: '/BookBus', label: 'Book a Bus' },
                { to: '/checkstatus', label: 'Check Status' },
                { to: '/LastTransaction', label: 'My Bookings' },
                { to: '/MasterList', label: 'Passengers' },
              ].map((link) => (
                <li key={link.to}>
        ...
        <div className="border-t border-surface-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-surface-500">
            © 2024 BlueBus. All rights reserved.
          </p>
          <p className="text-sm text-surface-500">
